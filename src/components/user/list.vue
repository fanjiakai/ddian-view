          ...
          <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
            ...
            <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
              <el-form :inline="true" :model="filters">
                <el-form-item>
                  <el-input v-model="filters.name" size="small " placeholder="用户名/姓名/昵称" style="min-width: 240px;"
                ...
                <el-form-item>
                  <el-button v-has="'admin:user:add'" type="primary" size="small " @click="showAddDialog">添加</el-button>
                </el-form-item>
              </el-form>
            </el-col>
           ...
           <!--   <el-table-column type="index" width="60">
              ...
              <el-table-column label="操作" width="150">
                <template slot-scope="scope">
                  ...
                  <el-button size="mini" disabled type="danger" @click="removeUser(scope.$index,scope.row)">删除
                  </el-button>
                </template>
              </el-table-column>
            </el-table>
