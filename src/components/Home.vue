  ...
  export default {
    ...
    methods: {
      ...
      loadAreaTree: function () {
        var areaData =JSON.parse( localStorage.getItem("area"));
        var areaInfo = areaData[0];
        this.areaLabel.id = areaInfo.object.code;
        this.areaLabel.text = areaInfo.text;
        this.data = areaData;
        bus.$emit("transmitArea", {areaCode:  areaInfo.object.code,areaName:areaInfo.text});
      },
      logout() {
        let that = this;
